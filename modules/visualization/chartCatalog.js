// src/modules/visualization/chartCatalog.js
...
export const chartCatalog = [
  ...
  },
  {
    ...
    whenToUse:
      "Use when you want to compare frequency across discrete groups.",
    recommended: true,
    recommendationReason:
  ...
  },
  {
    ...
    title: "Box Plot",
    purpose:
      "Summarizes distribution and highlights potential outliers using quartiles.",
    whenToUse:
  ...
  },
  {
    ...
    purpose:
      "Shows change over time or ordered progression.",
    whenToUse:
      "Use when the dataset includes a time field or meaningful sequence.",
    recommended: false,
    recommendationReason:
