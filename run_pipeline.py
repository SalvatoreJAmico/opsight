...
def run_pipeline(input_data=None, source_mode: str = None, data_format: str = None):
    ...
    try:
        ...
        try:
            ...
            raw_data = ingest_data(source_path=input_data, source_mode=source_mode, data_format=data_format)
